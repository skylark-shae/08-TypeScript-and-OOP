...
class Cli {
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (selectedVehicle instanceof Truck) {
            this.findVehicleToTow(selectedVehicle); // Pass the selected truck
          ...
          //   return; // Return after performing wheelie
          // } else {
          ...
          if (selectedVehicle instanceof Motorbike) {
            console.log('Performing a wheelie!');
            this.performActions(); // Call to return to action selection
            return; // Ensure we exit this block
          } else {
            console.log('Only motorbikes can perform a wheelie.');
          }
      ...
      }); // Closing bracket for the then block
  }
